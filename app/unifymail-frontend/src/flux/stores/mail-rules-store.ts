...
import { DatabaseChangeRecord } from 'unifymail-exports';
...
class MailRulesStore extends UnifyMailStore {
  ...
  constructor() {
    ...
    mail that has arrived since they last ran UnifyMail. So, we keep a date. */
