  ...
  menu: [
    {
      ...
      label: 'UnifyMail',
      submenu: [
        { label: localized('About UnifyMail'), command: 'application:about' },
        ...
        { type: 'separator' },
        { label: localized('Hide UnifyMail'), command: 'application:hide' },
...

    {
      ...
      submenu: [
        { label: localized('UnifyMail Help'), command: 'application:view-help' },
        { type: 'separator' },
        { label: localized('Getting Started Guide'), command: 'application:view-getting-started' },
        { label: localized('UnifyMail Community'), command: 'application:view-community' },
      ],
    },
  ],
};
