import { Message, Contact } from 'unifymail-exports';
...
export class ComposerExtension {
  ...
  */
  ...
  //
  // - `iconUrl`: The url of your icon. It should be in the `UnifyMail://`
  // scheme.  For example: `UnifyMail://your-package-name/assets/my-icon@2x.png`.
