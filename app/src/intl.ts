...
// For now, we only default to a localized version of UnifyMail if the translations
...
// The locale UnifyMail will default to. We do not default to unverified translations
