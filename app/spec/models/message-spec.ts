...
const team = new Contact({
  name: 'UnifyMail Team',
  email: 'team@UnifyMail.com',
});
const edgehill = new Contact({
  name: 'Edgehill',
  email: 'edgehill@UnifyMail.com',
});
...
const almost_me = new Contact({
  name: TEST_ACCOUNT_NAME,
  email: 'tester+12345@UnifyMail.com',
});
    ...
    const cases = [
      {
        ...
        body: `\
<div class="contenteditable no-open-link-events" contenteditable="true" spellcheck="false"><br><br><signature>Sent from <a href="https://github.com/TheDarkSkyXD/UnifyMail">UnifyMail</a>, the extensible, open source mail client.</signature></div>\
`,
        isEmpty: true,
      },
      {
      ...
      },
      {
        ...
        body: `\
<div class="contenteditable no-open-link-events" contenteditable="true" spellcheck="false"><br><div><p>  </p></div>\n\n\n\n<br><signature>Sent from <a href="https://github.com/TheDarkSkyXD/UnifyMail">UnifyMail</a>, the extensible, open source mail client.</signature></div>\
`,
        isEmpty: true,
      },
      {
