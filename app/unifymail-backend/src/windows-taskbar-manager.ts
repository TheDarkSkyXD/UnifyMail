...
class WindowsTaskbarManager {
   ...
   *
   * Uses mailto: and UnifyMail: protocol URLs so that clicks are routed
      ...
      app.setJumpList([
        {
          ...
          items: [
            ...
            },
            {
              ...
              description: localized('Open UnifyMail preferences'),
              program: process.execPath,
              args: 'UnifyMail://open-preferences',
              iconPath: process.execPath,
              iconIndex: 0,
            },
          ],
