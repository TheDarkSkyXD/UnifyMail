...
import { localized, initializeLocalization } from '../../unifymail-frontend/src/intl';
...
import { DefaultClientHelper } from '../../unifymail-frontend/src/default-client-helper';
...
import { MailsyncProcess } from '../../unifymail-frontend/src/mailsync-process';
...
export default class Application extends EventEmitter {
  ...
  async start(options) {
    ...
    const Config = require('../../unifymail-frontend/src/config').default;
