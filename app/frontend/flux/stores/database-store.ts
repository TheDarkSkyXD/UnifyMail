...
import UnifyMailStore from '../../global/unifymail-store';
...
/*
Public: UnifyMail is built on top of a custom database layer modeled after
...
Section: Database
*/
class DatabaseStore extends UnifyMailStore {
  _open = false;
  _waiting = [];
