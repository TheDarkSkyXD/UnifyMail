...
module.exports = grunt => {
  ...
  const buildDir = path.resolve(path.join('build'));
  ...
  grunt.config.init({
    ...
    'source:es6': [
      ...
      'unifymail-frontend/src/**/*.ts',
      'unifymail-frontend/src/**/*.tsx',
      'unifymail-frontend/src/**/*.jsx',
      'unifymail-backend/src/**/*.ts',
      'unifymail-backend/src/**/*.tsx',
      'unifymail-backend/src/**/*.jsx',

      '!unifymail-frontend/**/node_modules/**/*.ts',
      '!unifymail-frontend/**/node_modules/**/*.tsx',
      '!unifymail-frontend/**/node_modules/**/*.jsx',
      '!unifymail-backend/**/node_modules/**/*.ts',
      '!unifymail-backend/**/node_modules/**/*.tsx',
      '!unifymail-backend/**/node_modules/**/*.jsx',
